...
- [ ] Build deterministic synthetic profiles covering clear, noisy, weak, absent, and multi-transition cliffs.
...
- [ ] Add current R package CI using maintained actions and an appropriate Bioconductor environment.
